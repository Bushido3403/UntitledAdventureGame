// Access the API and return the result.
// Pass the use prompt, the character content, and any relevant system prompts.
// Remember to handle inappropriate content according to the game guidelines, more custom responses than OpenAI's default.

#include "ChatGPT.h"
#include <cpr/cpr.h>
#include <nlohmann/json.hpp>
#include <iostream>
#include "ChatGPTError.h"
